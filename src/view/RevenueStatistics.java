    ...
    private void initComponents() {
        ...
        jpStatisticsByMonthLayout.setVerticalGroup(
            ...
            .addGroup(jpStatisticsByMonthLayout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(jl_ThongBao_Thang, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//                    System.out.println("adsfadsfads" + year);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            if(year2 - year1 >= 1)
            {
                if(year1 < currentYear - 4 || year2 > currentYear)
                {
                    jpChart.setVisible(false);
                    jL_ThongBao_Nam.setText("Vui lòng nhập từ năm cần tìm đến khoảng 4 năm trở về trước!");
                    jTextNam1_Nam.setText("");
                    jTextNam2_Nam.setText("");
                }
                else
            ...
            else
            {
                ...
                if(year1 < currentYear - 5 && year2 < currentYear)
                {
                    jL_ThongBao_Nam.setText("Vui lòng nhập từ năm cần tìm đến khoảng 4 năm trở về trước!");
                    jTextNam1_Nam.setText("");
                    jTextNam2_Nam.setText("");
